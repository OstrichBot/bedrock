...
ADD $(curl -G https://www.minecraft.net/en-us/download/server/bedrock/ | grep -Eo "https://minecraft.azureedge.net/bin-linux/bedrock-server-.*\.zip") bedrock-server.zip
